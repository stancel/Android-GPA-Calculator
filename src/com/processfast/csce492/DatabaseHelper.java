...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE " + AssignmentTypesTable + 
				" (" +
				colTypeID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
				colTypeCourseID + " INTEGER REFERENCES " + coursesTable + "(" + colCourseID + ")," +
		...
		db.execSQL("CREATE TABLE " + coursesTable + 
				...
				colGradeTypeID + " INTEGER REFERENCES " + AssignmentTypesTable + "(" + colTypeID + ")," +
				colGradeCourseID + " INTEGER REFERENCES " + coursesTable + "(" + colCourseID + ")," +
				colMaxGrade + " INTEGER NOT NULL, " +
				colGradeName + " TEXT NOT NULL," +
				colGrade + " INTEGER NOT NULL" + 
				");");
	}
